...
link:https://github.com/grpc/grpc/blob/main/doc/PROTOCOL-HTTP2.md[gRPC wire protocol] for the JVM and is used
...
link:https://github.com/grpc/grpc/blob/main/doc/PROTOCOL-HTTP2.md[gRPC wire protocol] is relatively small but it
...
link:https://github.com/grpc/grpc/blob/main/doc/PROTOCOL-HTTP2.md[gRPC wire protocol] and provides ServiceTalk APIs
