...
link:{sourceroot}servicetalk-http-security-jersey/src/main/java/io/servicetalk/http/security/auth/basic/jersey/BasicAuthSecurityContextFilters.java[`BasicAuthSecurityContextFilters`]
...
link:{sourceroot}servicetalk-http-security-jersey/src/main/java/io/servicetalk/http/security/auth/basic/jersey/BasicAuthenticated.java[`@BasicAuthenticated`] annotation.
