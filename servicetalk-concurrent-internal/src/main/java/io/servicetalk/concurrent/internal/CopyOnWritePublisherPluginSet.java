...
final class CopyOnWritePublisherPluginSet implements PublisherPlugin {
    private final AtomicReference<CopyOnWriteSet> setRef = new AtomicReference<>(EmptyPublisherPluginSet.INSTANCE);
    ...
    private interface CopyOnWriteSet extends PublisherPlugin {
        CopyOnWriteSet add(PublisherPlugin plugin);

        CopyOnWriteSet remove(PublisherPlugin plugin);
    }

    private static final class EmptyPublisherPluginSet implements CopyOnWriteSet {
        static final CopyOnWriteSet INSTANCE = new EmptyPublisherPluginSet();
        ...
        @Override
        public CopyOnWriteSet add(final PublisherPlugin plugin) {
            return new OnePublisherPluginSet(plugin);
        }

        @Override
        public CopyOnWriteSet remove(final PublisherPlugin plugin) {
            return this;
        }
    ...
    private static final class OnePublisherPluginSet implements CopyOnWriteSet {
    ...
    private static final class TwoPublisherPluginSet implements CopyOnWriteSet {
    ...
    private static final class ThreeOrMorePublisherPluginSet implements CopyOnWriteSet {
