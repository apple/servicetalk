...
/**
 * Extensibility point provided by {@link Completable} for visibility into asynchronous events.
 */
public interface CompletablePlugin {
    /**
     * Extension point for {@link Completable#subscribe(Subscriber)}.
     * @param subscriber The {@link Subscriber}.
     * @param offloader The {@link SignalOffloader}.
     * @param handleSubscribe The resulting {@link Completable#subscribe(Subscriber)} method.
     */
