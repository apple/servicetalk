...
final class CopyOnWriteSinglePluginSet implements SinglePlugin {
    private final AtomicReference<CopyOnWriteSet> setRef = new AtomicReference<>(EmptySinglePluginSet.INSTANCE);
    ...
    private interface CopyOnWriteSet extends SinglePlugin {
        CopyOnWriteSet add(SinglePlugin plugin);

        CopyOnWriteSet remove(SinglePlugin plugin);
    }
    ...
    private static final class EmptySinglePluginSet implements CopyOnWriteSet {
        static final CopyOnWriteSet INSTANCE = new EmptySinglePluginSet();
        ...
        @Override
        public CopyOnWriteSet add(final SinglePlugin plugin) {
            return new OneSinglePluginSet(plugin);
        }

        @Override
        public CopyOnWriteSet remove(final SinglePlugin plugin) {
            return this;
        }
    }

    private static final class OneSinglePluginSet implements CopyOnWriteSet {
    ...
    private static final class TwoSinglePluginSet implements CopyOnWriteSet {
    ...
    private static final class ThreeOrMoreSinglePluginSet implements CopyOnWriteSet {
