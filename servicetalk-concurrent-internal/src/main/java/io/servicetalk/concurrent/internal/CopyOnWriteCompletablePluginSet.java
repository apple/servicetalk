...
final class CopyOnWriteCompletablePluginSet implements CompletablePlugin {
    private final AtomicReference<CopyOnWriteSet> setRef = new AtomicReference<>(EmptyCompletablePluginSet.INSTANCE);
    ...
    private interface CopyOnWriteSet extends CompletablePlugin {
        CopyOnWriteSet add(CompletablePlugin plugin);

        CopyOnWriteSet remove(CompletablePlugin plugin);
    }

    private static final class EmptyCompletablePluginSet implements CopyOnWriteSet {
        static final CopyOnWriteSet INSTANCE = new EmptyCompletablePluginSet();
        ...
        @Override
        public CopyOnWriteSet add(final CompletablePlugin plugin) {
            return new OneCompletablePluginSet(plugin);
        }

        @Override
        public CopyOnWriteSet remove(final CompletablePlugin plugin) {
            return this;
        }
    ...
    private static final class OneCompletablePluginSet implements CopyOnWriteSet {
    ...
    private static final class TwoCompletablePluginSet implements CopyOnWriteSet {
    ...
    private static final class ThreeOrMoreCompletablePluginSet implements CopyOnWriteSet {
