...
/**
 * Builder for {@link SslConfig} for clients, used for chaining builders.
 *
 * @param <F> The type to return from {@link #finish()}, for chaining builders.
 * @see SslConfigBuilders for static factory methods.
 */
public final class ClientSslConfigBuilder<F> extends BaseClientSslConfigBuilder<ClientSslConfigBuilder<F>, F> {
    ClientSslConfigBuilder(final Supplier<F> finisher, final Consumer<SslConfig> configConsumer) {
