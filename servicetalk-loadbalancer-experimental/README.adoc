...
specification that was pioneered by the Envoy project and is being https://github.com/cncf/xds[advanced bythe CNCF].
...
or control-plane support we can explicitly propagate weight information to ServiceTalks DefaultLoadBalancer. Adding
