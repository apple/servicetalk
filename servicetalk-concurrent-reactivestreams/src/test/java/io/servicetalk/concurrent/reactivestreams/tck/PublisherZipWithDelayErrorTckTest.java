...
@Test
public class PublisherZipWithDelayErrorTckTest extends AbstractPublisherZipTckTest {
    @Override
    protected Publisher<Integer> composePublisher(final Publisher<Integer> publisher, final int elements) {
        return publisher.zipWithDelayError(range(0, elements), (result, ignore) -> result);
    }
}
