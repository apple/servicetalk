...
@Test
public class PublisherOnErrorResumeClassTckTest extends AbstractPublisherTckTest<Integer> {
    @Override
    public Publisher<Integer> createServiceTalkPublisher(long elements) {
        ...
        return TckUtils.<Integer>newFailedPublisher()
                .onErrorResume(DeliberateException.class, t -> TckUtils.newPublisher(numElements));
    }
