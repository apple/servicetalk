...
@Test
public class PublisherZip4DelayErrorTckTest extends AbstractPublisherZipTckTest {
    @Override
    protected Publisher<Integer> composePublisher(final Publisher<Integer> publisher, final int elements) {
        return zipDelayError(publisher, range(0, elements), range(0, elements), range(0, elements),
                (result, ignored1, ignored2, ignored3) -> result);
    }
}
