...
@Test
public class PublisherZip3DelayErrorTckTest extends AbstractPublisherZipTckTest {
    @Override
    protected Publisher<Integer> composePublisher(final Publisher<Integer> publisher, final int elements) {
        return zipDelayError(publisher, range(0, elements), range(0, elements), (result, ignored1, ignored2) -> result);
    }
}
