...
abstract class TaskBasedAsyncCompletableOperator extends AbstractAsynchronousCompletableOperator {
     ...
     */
    static final class OffloadedCancellableCompletableSubscriber implements Subscriber {
        private final Subscriber subscriber;
        private final Executor executor;

        OffloadedCancellableCompletableSubscriber(final Subscriber subscriber,
                                                  final Executor executor) {
            this.subscriber = requireNonNull(subscriber);
            this.executor = executor;
        }
