...
final class ResumePublisher<T> extends AbstractNoHandleSubscribePublisher<T> {
    ...
    private static final class ResumeSubscriber<T> implements Subscriber<T> {
        ...
        @Nullable
        private volatile Function<? super Throwable, ? extends Publisher<? extends T>> nextFactory;
        ...
        public void onError(Throwable t) {
            final Function<? super Throwable, ? extends Publisher<? extends T>> nextFactory = this.nextFactory;
            if (nextFactory == null) {
