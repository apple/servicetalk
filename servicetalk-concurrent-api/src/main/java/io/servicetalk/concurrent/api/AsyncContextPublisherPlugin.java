...
import io.servicetalk.concurrent.internal.PublisherPlugin;
...
final class AsyncContextPublisherPlugin implements PublisherPlugin {
    static final PublisherPlugin PUBLISHER_PLUGIN = new AsyncContextPublisherPlugin();

    private AsyncContextPublisherPlugin() {
        // singleton
    }
