...
final class ResumeCompletable extends AbstractNoHandleSubscribeCompletable {
    ...
    private static final class ResumeSubscriber implements Subscriber {
        ...
        @Nullable
        private volatile Function<? super Throwable, ? extends Completable> nextFactory;
        ...
        public void onError(Throwable throwable) {
            final Function<? super Throwable, ? extends Completable> nextFactory = this.nextFactory;
            if (nextFactory == null) {
