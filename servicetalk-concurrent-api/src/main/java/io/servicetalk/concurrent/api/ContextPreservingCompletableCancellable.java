...
final class ContextPreservingCompletableCancellable implements Subscriber {
    private final AsyncContextMap saved;
    private final Completable.Subscriber subscriber;

    ContextPreservingCompletableCancellable(Completable.Subscriber subscriber, AsyncContextMap current) {
