...
final class ExecutorPluginSet implements ExecutorPlugin {
    private final AtomicReference<ProgressiveSet> setRef = new AtomicReference<>(EmptyExecutorPluginSet.INSTANCE);
    ...
    private interface ProgressiveSet extends ExecutorPlugin {
        ProgressiveSet add(ExecutorPlugin plugin);

        ProgressiveSet remove(ExecutorPlugin plugin);
    }

    private static final class EmptyExecutorPluginSet implements ProgressiveSet {
        static final ProgressiveSet INSTANCE = new EmptyExecutorPluginSet();
        ...
        @Override
        public ProgressiveSet add(final ExecutorPlugin plugin) {
            return new OneExecutorPluginSet(plugin);
        }

        @Override
        public ProgressiveSet remove(final ExecutorPlugin plugin) {
            return this;
        }
    ...
    private static final class OneExecutorPluginSet implements ProgressiveSet {
    ...
    private static final class TwoExecutorPluginSet implements ProgressiveSet {
    ...
    private static final class ThreeOrMoreExecutorPluginSet implements ProgressiveSet {
