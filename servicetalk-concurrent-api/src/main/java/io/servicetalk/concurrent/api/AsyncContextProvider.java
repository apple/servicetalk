...
interface AsyncContextProvider {
     ...
     * {@link Cancellable}.
     * @param current The current {@link ContextMap}.
     * @return The wrapped {@link CompletableSource.Subscriber}.
     */
    CompletableSource.Subscriber wrapCancellable(CompletableSource.Subscriber subscriber, ContextMap current);
     ...
     */
    <T> SingleSource.Subscriber<T> wrapCancellable(SingleSource.Subscriber<T> subscriber, ContextMap current);
     ...
     * @return The wrapped subscriber.
     */
    <T> SingleSource.Subscriber<T> wrapSingleSubscriber(SingleSource.Subscriber<T> subscriber, ContextMap current);
     ...
     */
    <T> CompletableFuture<T> wrapCompletableFuture(CompletableFuture<T> future, ContextMap current);
     ...
     */
    Runnable wrapRunnable(Runnable runnable, ContextMap current);
     ...
     */
    <V> Callable<V> wrapCallable(Callable<V> callable, ContextMap current);
     ...
     */
    <T> Consumer<T> wrapConsumer(Consumer<T> consumer, ContextMap current);
     ...
     */
    <T, U> Function<T, U> wrapFunction(Function<T, U> func, ContextMap current);
     ...
     */
    <T, U> BiConsumer<T, U> wrapBiConsumer(BiConsumer<T, U> consumer, ContextMap current);
     ...
     */
    <T, U, V> BiFunction<T, U, V> wrapBiFunction(BiFunction<T, U, V> func, ContextMap current);
}
