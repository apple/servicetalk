 ...
 * </ul>
 *
 * @param <T> Type of the result of this {@code TestSingle2}.
 */
public final class TestSingle2<T> extends Single<T> implements SingleSource<T> {
    private static final Logger LOGGER = LoggerFactory.getLogger(TestSingle2.class);
    ...
    /**
     * Create a {@code TestSingle2} with the defaults. See <b>Defaults</b> section of class javadoc.
     */
    public TestSingle2() {
        this(new Builder<T>().buildSubscriberFunction());
    }

    private TestSingle2(final Function<Subscriber<? super T>, Subscriber<? super T>> subscriberFunction) {
        this.subscriberFunction = subscriberFunction;
    }

    /**
     * Returns {@code true} if this {@link TestSingle2} has been subscribed to, {@code false} otherwise.
     *
     * @return {@code true} if this {@link TestSingle2} has been subscribed to, {@code false} otherwise.
     */
    ...
    /**
     * Allows for creating {@link TestSingle2}s with non-default settings. For defaults, see <b>Defaults</b> section
     * of class javadoc.
     *
     * @param <T> Type of the result of the {@code TestSingle2}.
     */
    public static class Builder<T> {
        ...
        /**
         * Create a {@link TestSingle2} using the specified subscriber function.
         * <p>
         * All other settings from this {@link Builder} will be ignored.
         *
         * @param function The subscriber function to use.
         * @return a new {@link TestSingle2}.
         */
        public TestSingle2<T> build(final Function<Subscriber<? super T>, Subscriber<? super T>> function) {
            return new TestSingle2<>(requireNonNull(function));
        }
        ...
        /**
         * Create a {@link TestSingle2} as configured by the builder.
         *
         * @return a new {@link TestSingle2}.
         */
        public TestSingle2<T> build() {
            return new TestSingle2<>(buildSubscriberFunction());
        }
