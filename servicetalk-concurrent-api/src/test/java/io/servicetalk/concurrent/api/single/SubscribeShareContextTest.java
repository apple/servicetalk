...
public class SubscribeShareContextTest {
    ...
    public void contextIsShared() throws Exception {
        ...
        succeeded(1).doBeforeSuccess(__ -> AsyncContext.put(KEY, "v2")).subscribeShareContext().toFuture().get();
    ...
    public void contextIsNotSharedIfNotLastOperator() throws Exception {
        ...
        AsyncContext.put(KEY, "v1");
        succeeded(1).doBeforeSuccess(__ -> AsyncContext.put(KEY, "v2"))
                .subscribeShareContext().doBeforeSuccess(__ -> { }).toFuture().get();
