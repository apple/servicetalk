...
import static io.servicetalk.concurrent.api.ReactiveStreamsAdapters.fromReactiveStreamsPublisher;
...
public class ReactiveStreamsAdaptersTest {
    ...
    public void fromRSSuccess() throws Exception {
        ...
        Integer result = fromReactiveStreamsPublisher(rsPublisher).first().toFuture().get();
    ...
    public void fromRSError() throws Exception {
        ...
        Future<Integer> future = fromReactiveStreamsPublisher(rsPublisher).first().toFuture();
    ...
    public void fromRSCancel() {
        ...
        fromReactiveStreamsPublisher(rsPublisher).first().toFuture().cancel(true);
    ...
    public void toRSError() {
        verifyRSError(toRSPublisherAndSubscribe(error(DELIBERATE_EXCEPTION)));
    }
