...
final class PublisherZip5Test {
    ...
    private TestSubscription fourthSubscription;
    private TestSubscription fifthSubscription;
    private TestPublisher<Integer> first;
    private TestPublisher<Double> second;
    private TestPublisher<Short> third;
    private TestPublisher<Byte> fourth;
    private TestPublisher<Boolean> fifth;
    ...
    void setUp() {
        ...
        fourthSubscription = new TestSubscription();
        fifthSubscription = new TestSubscription();
        ...
        fourth = new TestPublisher.Builder<Byte>().disableAutoOnSubscribe().build(subscriber1 -> {
            subscriber1.onSubscribe(fourthSubscription);
            return subscriber1;
        });
        fifth = new TestPublisher.Builder<Boolean>().disableAutoOnSubscribe().build(subscriber1 -> {
            subscriber1.onSubscribe(fifthSubscription);
            return subscriber1;
        });
    ...
    void allComplete(boolean inOrderCompletion, boolean onError) throws InterruptedException {
        ...
        fourthSubscription.awaitRequestN(1);
        fifthSubscription.awaitRequestN(1);
        ...
        assertThat(subscriber.takeOnNext(), equalTo(combine(i, d, s, b, bool)));
    ...
    void cancelWhilePending(boolean inOrderCompletion) throws InterruptedException {
        ...
        fourthSubscription.awaitCancelled();
        fifthSubscription.awaitCancelled();
    }
    ...
    void maxOutstandingDemand(boolean inOrderCompletion, boolean onError) throws InterruptedException {
        toSource(zip(combineFunc(), 1, first, second, third, fourth, fifth)).subscribe(subscriber);
        ...
        fourthSubscription.awaitRequestN(1);
        assertThat(fourthSubscription.requested(), equalTo(1L));
        fifthSubscription.awaitRequestN(1);
        assertThat(fifthSubscription.requested(), equalTo(1L));
        ...
        fourthSubscription.awaitRequestN(2);
        assertThat(fourthSubscription.requested(), equalTo(2L));
        fifthSubscription.awaitRequestN(2);
        assertThat(fifthSubscription.requested(), equalTo(2L));
    ...
    void reentry(int begin, int end) throws InterruptedException {
        ...
        toSource(zip(reentryCombineFunc(), 1,
        ...
        for (int i = begin; i < end; ++i) {
            signal = signals.take();
            assertThat(signal, equalTo(combineReentry(i, i, i, i, i)));
        }
        signal = signals.take();
    ...
    private static String combineReentry(int i, int d, int s, int b, int bool) {
        return "first: " + i + " second: " + d + " third: " + s + " forth: " + b + " fifth: " + bool;
    }
    ...
    private static Function<? super Object[], ? extends String> reentryCombineFunc() {
        return objects -> combineReentry((Integer) objects[0], (Integer) objects[1], (Integer) objects[2],
