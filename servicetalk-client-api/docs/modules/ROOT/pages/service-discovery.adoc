...
link:https://datatracker.ietf.org/doc/html/rfc1035[Domain Name System (DNS)] to resolve hosts represented by domain name into a
set of IP-addresses needed for _Clients_ to connect to the remote servers. Resolution happens every
link:https://datatracker.ietf.org/doc/html/rfc1035#section-3.2.1[TTL] seconds.
