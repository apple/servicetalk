...
This module defines the ServiceTalk client and server API for the link:https://datatracker.ietf.org/doc/html/rfc7231[HTTP/1.x]
and link:https://datatracker.ietf.org/doc/html/rfc7540[HTTP/2] protocols. This module supports all the different
...
=== MultiAddress Client
This `Client` parses the link:https://datatracker.ietf.org/doc/html/rfc7230#section-5.3[request-target] to determine the remote
...
ServiceTalk supports both link:https://datatracker.ietf.org/doc/html/rfc7231[HTTP/1.x] and
link:https://datatracker.ietf.org/doc/html/rfc7540[HTTP/2] protocols.
...
link:https://datatracker.ietf.org/doc/html/rfc7301[ALPN extension].
