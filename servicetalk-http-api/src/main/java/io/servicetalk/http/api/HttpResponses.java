...
public final class HttpResponses {
     ...
     * @return a new {@link HttpResponse}.
     */
    public static <T> HttpResponse<T> newResponse(final HttpResponseStatus status,
                                                  final T payloadBody) {
        return newResponse(HTTP_1_1, status, payloadBody);
    }
     ...
     * @return a new {@link HttpResponse}.
     */
    public static <T> HttpResponse<T> newResponse(final HttpProtocolVersion version,
                                                  final HttpResponseStatus status,
                                                  final T payloadBody) {
        return newResponse(version, status, payloadBody, INSTANCE.newHeaders());
    }
