...
final class StreamingHttpClientToHttpClient extends HttpClient {
    ...
    static final class UpgradableStreamingHttpResponseToUpgradableHttpResponse implements UpgradableHttpResponse {
        ...
        @Override
        public UpgradableHttpResponse addHeader(final CharSequence name, final CharSequence value) {
            upgradableResponse.addHeader(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse addHeaders(final CharSequence name,
        ...
        @Override
        public UpgradableHttpResponse addHeaders(final CharSequence name, final CharSequence... values) {
            upgradableResponse.addHeaders(name, values);
            return this;
        }

        @Override
        public UpgradableHttpResponse addHeaders(final HttpHeaders headers) {
            upgradableResponse.addHeaders(headers);
            return this;
        }

        @Override
        public UpgradableHttpResponse setHeader(final CharSequence name, final CharSequence value) {
            upgradableResponse.setHeader(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse setHeaders(final CharSequence name,
                                                 final Iterable<? extends CharSequence> values) {
        ...
        @Override
        public UpgradableHttpResponse setHeaders(final CharSequence name, final CharSequence... values) {
            upgradableResponse.setHeaders(name, values);
            return this;
        }

        @Override
        public UpgradableHttpResponse setHeaders(final HttpHeaders headers) {
            upgradableResponse.setHeaders(headers);
            return this;
        }

        @Override
        public UpgradableHttpResponse addCookie(final HttpCookie cookie) {
            upgradableResponse.addCookie(cookie);
            return this;
        }

        @Override
        public UpgradableHttpResponse addCookie(final CharSequence name, final CharSequence value) {
            upgradableResponse.addCookie(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse addSetCookie(final HttpCookie cookie) {
            upgradableResponse.addSetCookie(cookie);
            return this;
        }

        @Override
        public UpgradableHttpResponse addSetCookie(final CharSequence name, final CharSequence value) {
            upgradableResponse.addSetCookie(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse addTrailer(final CharSequence name, final CharSequence value) {
            trailers.add(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse addTrailer(final HttpHeaders trailers) {
            this.trailers.add(trailers);
            return this;
        }

        @Override
        public UpgradableHttpResponse setTrailer(final CharSequence name, final CharSequence value) {
            trailers.set(name, value);
            return this;
        }

        @Override
        public UpgradableHttpResponse setTrailer(final HttpHeaders trailers) {
