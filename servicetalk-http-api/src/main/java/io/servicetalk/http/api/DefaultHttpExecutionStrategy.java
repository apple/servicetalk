...
enum DefaultHttpExecutionStrategy implements HttpExecutionStrategy {
    ...
    OFFLOAD_ALL_REQRESP_CLOSE_STRATEGY(EnumSet.allOf(HttpExecutionStrategies.HttpOffload.class)),
    ...
    OFFLOAD_ALL_CLOSE_STRATEGY(EnumSet.allOf(HttpExecutionStrategies.HttpOffload.class));
