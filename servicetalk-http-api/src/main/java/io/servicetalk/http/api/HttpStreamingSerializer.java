...
public interface HttpStreamingSerializer<T> {
     ...
     * @return The result of the serialization operation.
     */
    default BlockingIterable<Buffer> serialize(HttpHeaders headers, BlockingIterable<T> value,
                                               BufferAllocator allocator) {
        return serialize(headers, Publisher.fromIterable(value), allocator).toIterable();
    }
