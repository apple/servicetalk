...
/**
 * Factory methods for creating {@link AggregatedHttpRequest}s.
 */
public final class AggregatedHttpRequests {

    private AggregatedHttpRequests() {
        // No instances
    }
     ...
     * request.
     * @return a new {@link AggregatedHttpRequest}.
     */
    public static AggregatedHttpRequest<HttpPayloadChunk> newRequest(final HttpRequestMethod method,
     ...
     * @return a new {@link AggregatedHttpRequest}.
     */
    public static AggregatedHttpRequest<HttpPayloadChunk> newRequest(final HttpProtocolVersion version,
     ...
     * @return a new {@link AggregatedHttpRequest}.
     */
    public static <T> AggregatedHttpRequest<T> newRequest(final HttpRequestMethod method,
                                                          final String requestTarget,
                                                          final T payloadBody) {
        return newRequest(HTTP_1_1, method, requestTarget, payloadBody);
    }
     ...
     * @return a new {@link AggregatedHttpRequest}.
     */
    public static <T> AggregatedHttpRequest<T> newRequest(final HttpProtocolVersion version,
                                                          final HttpRequestMethod method,
                                                          final String requestTarget,
                                                          final T payloadBody) {
        return newRequest(version, method, requestTarget, payloadBody, INSTANCE.newHeaders());
    ...
    public static AggregatedHttpRequest<HttpPayloadChunk> newRequest(final HttpProtocolVersion version,
                                                                     ...
                                                                     final Buffer payloadBody,
                                                                     final HttpHeaders headers) {
        return new DefaultAggregatedHttpRequest<>(new DefaultHttpRequestMetaData(method, requestTarget, version, headers),
