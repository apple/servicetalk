...
final class TransportStreamingHttpResponse extends DefaultHttpResponseMetaData implements StreamingHttpResponse {
    ...
    @Override
    public StreamingHttpResponse addHeader(final CharSequence name, final CharSequence value) {
    ...
    @Override
    public StreamingHttpResponse setHeaders(final HttpHeaders headers) {
        super.setHeaders(headers);
        return this;
    }

    @Override
    public StreamingHttpResponse addCookie(final HttpCookie cookie) {
        super.addCookie(cookie);
        return this;
    }

    @Override
    public StreamingHttpResponse addCookie(final CharSequence name, final CharSequence value) {
        super.addCookie(name, value);
        return this;
    }

    @Override
    public StreamingHttpResponse addSetCookie(final HttpCookie cookie) {
        super.addSetCookie(cookie);
        return this;
    }

    @Override
    public StreamingHttpResponse addSetCookie(final CharSequence name, final CharSequence value) {
