...
final class AggregatedHttpRequesterToHttpRequester extends HttpRequester {
    ...
    AggregatedHttpRequesterToHttpRequester(final AggregatedHttpRequester aggregatedRequester) {
        this.aggregatedRequester = requireNonNull(aggregatedRequester);
    }
    ...
    public ExecutionContext getExecutionContext() {
        return aggregatedRequester.getExecutionContext();
    }

    @Override
    public Completable onClose() {
        return aggregatedRequester.onClose();
    }

    @Override
    public Completable closeAsync() {
        return aggregatedRequester.closeAsync();
    }
