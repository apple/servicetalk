...
import static io.servicetalk.opentracing.core.internal.TracingConstants.NO_PARENT_ID;
...
public interface SingleLineValue {
    ...
    static String format(long traceId, long spanId, @Nullable Long parentSpanId) {
        return format(HexUtil.hexBytesOfLong(traceId), HexUtil.hexBytesOfLong(spanId), parentSpanId == null ? null :
                HexUtil.hexBytesOfLong(parentSpanId));
    }
