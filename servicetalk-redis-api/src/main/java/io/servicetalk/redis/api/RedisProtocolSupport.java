...
public final class RedisProtocolSupport {
    ...
    public enum CommandFlag {
        ...
        ADMIN, ASKING, DENYOOM, FAST, LOADING, MOVABLEKEYS, NOSCRIPT, PUBSUB, RANDOM, READONLY, SKIP_MONITOR,
        SORT_FOR_SCRIPT, STALE, WRITE
    }
    ...
    public enum Command implements RedisData.CompleteRequestRedisData {
        ...
        BGSAVE("BGSAVE", EnumSet.of(CommandFlag.ADMIN), false),
        BITCOUNT("BITCOUNT", EnumSet.of(CommandFlag.READONLY), true),
        ...
        FLUSHALL("FLUSHALL", EnumSet.of(CommandFlag.WRITE), false),
        FLUSHDB("FLUSHDB", EnumSet.of(CommandFlag.WRITE), false),
        GEOADD("GEOADD", EnumSet.of(CommandFlag.WRITE, CommandFlag.DENYOOM), true),
        GEODIST("GEODIST", EnumSet.of(CommandFlag.READONLY), true),
        GEOHASH("GEOHASH", EnumSet.of(CommandFlag.READONLY), true),
        ...
        PSUBSCRIBE("PSUBSCRIBE",
                    EnumSet.of(CommandFlag.PUBSUB, CommandFlag.NOSCRIPT, CommandFlag.LOADING, CommandFlag.STALE),
                    false),
        PTTL("PTTL", EnumSet.of(CommandFlag.READONLY, CommandFlag.FAST), true),
        PUBLISH("PUBLISH", EnumSet.of(CommandFlag.PUBSUB, CommandFlag.LOADING, CommandFlag.STALE, CommandFlag.FAST),
                    false),
        PUBSUB("PUBSUB", EnumSet.of(CommandFlag.PUBSUB, CommandFlag.RANDOM, CommandFlag.LOADING, CommandFlag.STALE),
                    false),
        ...
        READONLY("READONLY", EnumSet.of(CommandFlag.FAST), false),
        READWRITE("READWRITE", EnumSet.of(CommandFlag.FAST), false),
        ...
        XPENDING("XPENDING", EnumSet.of(CommandFlag.READONLY), true),
        XRANGE("XRANGE", EnumSet.of(CommandFlag.READONLY), true),
    ...
    public enum SubCommand implements RedisData.CompleteRequestRedisData {
        ...
        COUNT("COUNT"), COUNT_FAILURE_REPORTS("COUNT-FAILURE-REPORTS"), COUNTKEYSINSLOT("COUNTKEYSINSLOT"),
        DEBUG("DEBUG"), DELSLOTS("DELSLOTS"), DOCTOR("DOCTOR"), ENCODING("ENCODING"), EXISTS("EXISTS"),
        FAILOVER("FAILOVER"), FLUSH("FLUSH"), FORGET("FORGET"), FREQ("FREQ"), GET("GET"), GETKEYS("GETKEYS"),
        GETKEYSINSLOT("GETKEYSINSLOT"), GETNAME("GETNAME"), GROUP("GROUP"), HELP("HELP"), ID("ID"),
        IDLETIME("IDLETIME"), INCRBY("INCRBY"), INFO("INFO"), KEYSLOT("KEYSLOT"), KILL("KILL"), LIMIT("LIMIT"),
        LIST("LIST"), LOAD("LOAD"), MALLOC_STATS("MALLOC-STATS"), MATCH("MATCH"), MEET("MEET"), NODES("NODES"),
        NUMPAT("NUMPAT"), NUMSUB("NUMSUB"), OBJECT("OBJECT"), OVERFLOW("OVERFLOW"), PAUSE("PAUSE"), PURGE("PURGE"),
        REFCOUNT("REFCOUNT"), REPLICATE("REPLICATE"), REPLY("REPLY"), RESET("RESET"), RESETSTAT("RESETSTAT"),
        REWRITE("REWRITE"), SAMPLES("SAMPLES"), SAVECONFIG("SAVECONFIG"), SEGFAULT("SEGFAULT"), SET("SET"),
        SET_CONFIG_EPOCH("SET-CONFIG-EPOCH"), SETNAME("SETNAME"), SETSLOT("SETSLOT"), SKIPME("SKIPME"),
        SLAVES("SLAVES"), SLOTS("SLOTS"), STATS("STATS"), STORE("STORE"), STOREDIST("STOREDIST"), TYPE("TYPE"),
        USAGE("USAGE"), WEIGHTS("WEIGHTS");
