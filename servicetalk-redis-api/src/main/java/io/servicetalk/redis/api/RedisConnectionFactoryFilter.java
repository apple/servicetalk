 ...
 */
@FunctionalInterface
public interface RedisConnectionFactoryFilter<ResolvedAddress> {
     ...
     */
    ConnectionFactory<ResolvedAddress, ? extends RedisConnection> apply(
            ConnectionFactory<ResolvedAddress, ? extends RedisConnection> original);
     ...
     */
    default RedisConnectionFactoryFilter<ResolvedAddress> append(RedisConnectionFactoryFilter<ResolvedAddress> before) {
     ...
     */
    static <ResolvedAddress> RedisConnectionFactoryFilter<ResolvedAddress> identity() {
