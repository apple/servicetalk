...
final class BlockingPartitionedBufferRedisCommanderToPartitionedBufferRedisCommander extends BufferRedisCommander {

    private final BlockingBufferRedisCommander partitionedRedisClient;

    BlockingPartitionedBufferRedisCommanderToPartitionedBufferRedisCommander(
                final BlockingBufferRedisCommander partitionedRedisClient) {
    ...
    public Single<Long> zinterstore(@RedisProtocolSupport.Key final Buffer destination, final long numkeys,
        ...
        return blockingToSingle(
                    () -> partitionedRedisClient.zinterstore(destination, numkeys, keys, weightses, aggregate));
    }
    ...
    public Single<Long> zunionstore(@RedisProtocolSupport.Key final Buffer destination, final long numkeys,
        ...
        return blockingToSingle(
                    () -> partitionedRedisClient.zunionstore(destination, numkeys, keys, weightses, aggregate));
    }
