...
final class RedisCommanderToBlockingRedisCommander extends BlockingRedisCommander {

    private final RedisCommander commander;

    RedisCommanderToBlockingRedisCommander(final RedisCommander commander) {
