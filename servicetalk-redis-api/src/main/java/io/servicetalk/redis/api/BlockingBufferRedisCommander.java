...
public abstract class BlockingBufferRedisCommander implements AutoCloseable {
    ...
    public abstract Long append(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
    ...
    public abstract Long bitcount(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.BITCOUNT)
    public abstract Long bitcount(@RedisProtocolSupport.Key Buffer key, @Nullable Long start,
    ...
    public abstract List<Long> bitfield(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract Long bitop(Buffer operation, @RedisProtocolSupport.Key Buffer destkey,
    ...
    public abstract Long bitpos(@RedisProtocolSupport.Key Buffer key, long bit) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.BITPOS)
    public abstract Long bitpos(@RedisProtocolSupport.Key Buffer key, long bit, @Nullable Long start,
                                @Nullable Long end) throws Exception;
    ...
    public abstract <T> List<T> blpop(@RedisProtocolSupport.Key Collection<Buffer> keys, long timeout) throws Exception;
    ...
    public abstract <T> List<T> brpop(@RedisProtocolSupport.Key Collection<Buffer> keys, long timeout) throws Exception;
     ...
     * @param timeout the timeout
     * @return a {@link Buffer} result
     * @throws Exception if an exception occurs during the request processing.
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.BRPOPLPUSH)
    public abstract Buffer brpoplpush(@RedisProtocolSupport.Key Buffer source,
    ...
    public abstract <T> List<T> bzpopmax(@RedisProtocolSupport.Key Collection<Buffer> keys,
    ...
    public abstract <T> List<T> bzpopmin(@RedisProtocolSupport.Key Collection<Buffer> keys,
                                         long timeout) throws Exception;
    ...
    public abstract Buffer clientList() throws Exception;
    ...
    public abstract Buffer clientGetname() throws Exception;
    ...
    public abstract Long clusterCountFailureReports(Buffer nodeId) throws Exception;
    ...
    public abstract Buffer clusterInfo() throws Exception;
    ...
    public abstract Long clusterKeyslot(Buffer key) throws Exception;
    ...
    public abstract Buffer clusterNodes() throws Exception;
    ...
    public abstract Buffer clusterSlaves(Buffer nodeId) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.COMMAND)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.INFO)
    public abstract <T> List<T> commandInfo(Buffer commandName) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.COMMAND)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.INFO)
    public abstract <T> List<T> commandInfo(Buffer commandName1, Buffer commandName2) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.COMMAND)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.INFO)
    public abstract <T> List<T> commandInfo(Buffer commandName1, Buffer commandName2,
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.COMMAND)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.INFO)
    public abstract <T> List<T> commandInfo(Collection<Buffer> commandNames) throws Exception;
    ...
    public abstract <T> List<T> configGet(Buffer parameter) throws Exception;
    ...
    public abstract Long decr(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long decrby(@RedisProtocolSupport.Key Buffer key, long decrement) throws Exception;
    ...
    public abstract Long del(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.DEL)
    public abstract Long del(@RedisProtocolSupport.Key Buffer key1,
                             @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.DEL)
    public abstract Long del(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                             @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.DEL)
    public abstract Long del(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Buffer dump(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Buffer echo(Buffer message) throws Exception;
    ...
    public abstract Buffer eval(Buffer script, long numkeys, @RedisProtocolSupport.Key Collection<Buffer> keys,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EVAL)
    public abstract <T> List<T> evalList(Buffer script, long numkeys, @RedisProtocolSupport.Key Collection<Buffer> keys,
                                         Collection<Buffer> args) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EVAL)
    public abstract Long evalLong(Buffer script, long numkeys, @RedisProtocolSupport.Key Collection<Buffer> keys,
                                  Collection<Buffer> args) throws Exception;
    ...
    public abstract Buffer evalsha(Buffer sha1, long numkeys, @RedisProtocolSupport.Key Collection<Buffer> keys,
                                   Collection<Buffer> args) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EVALSHA)
    public abstract <T> List<T> evalshaList(Buffer sha1, long numkeys,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EVALSHA)
    public abstract Long evalshaLong(Buffer sha1, long numkeys, @RedisProtocolSupport.Key Collection<Buffer> keys,
                                     Collection<Buffer> args) throws Exception;
    ...
    public abstract Long exists(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EXISTS)
    public abstract Long exists(@RedisProtocolSupport.Key Buffer key1,
                                @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EXISTS)
    public abstract Long exists(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                                @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.EXISTS)
    public abstract Long exists(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Long expire(@RedisProtocolSupport.Key Buffer key, long seconds) throws Exception;
    ...
    public abstract Long expireat(@RedisProtocolSupport.Key Buffer key, long timestamp) throws Exception;
    ...
    public abstract Long geoadd(@RedisProtocolSupport.Key Buffer key, double longitude, double latitude,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOADD)
    public abstract Long geoadd(@RedisProtocolSupport.Key Buffer key, double longitude1, double latitude1,
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOADD)
    public abstract Long geoadd(@RedisProtocolSupport.Key Buffer key, double longitude1, double latitude1,
                                Buffer member1, double longitude2, double latitude2, Buffer member2, double longitude3,
                                double latitude3, Buffer member3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOADD)
    public abstract Long geoadd(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract Double geodist(@RedisProtocolSupport.Key Buffer key, Buffer member1,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEODIST)
    public abstract Double geodist(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
    ...
    public abstract <T> List<T> geohash(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOHASH)
    public abstract <T> List<T> geohash(@RedisProtocolSupport.Key Buffer key, Buffer member1,
                                        Buffer member2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOHASH)
    public abstract <T> List<T> geohash(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOHASH)
    public abstract <T> List<T> geohash(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract <T> List<T> geopos(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOPOS)
    public abstract <T> List<T> geopos(@RedisProtocolSupport.Key Buffer key, Buffer member1,
                                       Buffer member2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOPOS)
    public abstract <T> List<T> geopos(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
                                       Buffer member3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.GEOPOS)
    public abstract <T> List<T> geopos(@RedisProtocolSupport.Key Buffer key,
                                       Collection<Buffer> members) throws Exception;
    ...
    public abstract <T> List<T> georadius(@RedisProtocolSupport.Key Buffer key, double longitude, double latitude,
                                          double radius,
    ...
    public abstract <T> List<T> georadiusbymember(@RedisProtocolSupport.Key Buffer key, Buffer member, double radius,
    ...
    public abstract Buffer get(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long getbit(@RedisProtocolSupport.Key Buffer key, long offset) throws Exception;
    ...
    public abstract Buffer getrange(@RedisProtocolSupport.Key Buffer key, long start, long end) throws Exception;
    ...
    public abstract Buffer getset(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
    ...
    public abstract Long hdel(@RedisProtocolSupport.Key Buffer key, Buffer field) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.HDEL)
    public abstract Long hdel(@RedisProtocolSupport.Key Buffer key, Buffer field1, Buffer field2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.HDEL)
    public abstract Long hdel(@RedisProtocolSupport.Key Buffer key, Buffer field1, Buffer field2,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.HDEL)
    public abstract Long hdel(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> fields) throws Exception;
    ...
    public abstract Long hexists(@RedisProtocolSupport.Key Buffer key, Buffer field) throws Exception;
    ...
    public abstract Buffer hget(@RedisProtocolSupport.Key Buffer key, Buffer field) throws Exception;
    ...
    public abstract <T> List<T> hgetall(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long hincrby(@RedisProtocolSupport.Key Buffer key, Buffer field, long increment) throws Exception;
    ...
    public abstract Double hincrbyfloat(@RedisProtocolSupport.Key Buffer key, Buffer field,
    ...
    public abstract <T> List<T> hkeys(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long hlen(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract <T> List<T> hscan(@RedisProtocolSupport.Key Buffer key, long cursor) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.HSCAN)
    public abstract <T> List<T> hscan(@RedisProtocolSupport.Key Buffer key, long cursor,
    ...
    public abstract Long hset(@RedisProtocolSupport.Key Buffer key, Buffer field, Buffer value) throws Exception;
    ...
    public abstract Long hsetnx(@RedisProtocolSupport.Key Buffer key, Buffer field, Buffer value) throws Exception;
    ...
    public abstract Long hstrlen(@RedisProtocolSupport.Key Buffer key, Buffer field) throws Exception;
    ...
    public abstract <T> List<T> hvals(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long incr(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long incrby(@RedisProtocolSupport.Key Buffer key, long increment) throws Exception;
    ...
    public abstract Double incrbyfloat(@RedisProtocolSupport.Key Buffer key, double increment) throws Exception;
    ...
    public abstract Buffer info() throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.INFO)
    public abstract Buffer info(@Nullable Buffer section) throws Exception;
    ...
    public abstract <T> List<T> keys(Buffer pattern) throws Exception;
    ...
    public abstract Buffer lindex(@RedisProtocolSupport.Key Buffer key, long index) throws Exception;
    ...
    public abstract Long linsert(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract Long llen(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Buffer lpop(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long lpush(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.LPUSH)
    public abstract Long lpush(@RedisProtocolSupport.Key Buffer key, Buffer value1, Buffer value2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.LPUSH)
    public abstract Long lpush(@RedisProtocolSupport.Key Buffer key, Buffer value1, Buffer value2,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.LPUSH)
    public abstract Long lpush(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> values) throws Exception;
    ...
    public abstract Long lpushx(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
    ...
    public abstract <T> List<T> lrange(@RedisProtocolSupport.Key Buffer key, long start, long stop) throws Exception;
    ...
    public abstract Long lrem(@RedisProtocolSupport.Key Buffer key, long count, Buffer value) throws Exception;
    ...
    public abstract Buffer memoryDoctor() throws Exception;
    ...
    public abstract Buffer memoryMallocStats() throws Exception;
    ...
    public abstract Long memoryUsage(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.MEMORY)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.USAGE)
    public abstract Long memoryUsage(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract Long move(@RedisProtocolSupport.Key Buffer key, long db) throws Exception;
    ...
    public abstract Long msetnx(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.MSETNX)
    public abstract Long msetnx(@RedisProtocolSupport.Key Buffer key1, Buffer value1,
                                @RedisProtocolSupport.Key Buffer key2, Buffer value2) throws Exception;
    ...
    public abstract BlockingTransactedBufferRedisCommander multi() throws Exception;
    ...
    public abstract Buffer objectEncoding(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long objectFreq(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long objectIdletime(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long objectRefcount(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long persist(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long pexpire(@RedisProtocolSupport.Key Buffer key, long milliseconds) throws Exception;
    ...
    public abstract Long pexpireat(@RedisProtocolSupport.Key Buffer key, long millisecondsTimestamp) throws Exception;
    ...
    public abstract Long pfadd(@RedisProtocolSupport.Key Buffer key, Buffer element) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFADD)
    public abstract Long pfadd(@RedisProtocolSupport.Key Buffer key, Buffer element1, Buffer element2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFADD)
    public abstract Long pfadd(@RedisProtocolSupport.Key Buffer key, Buffer element1, Buffer element2,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFADD)
    public abstract Long pfadd(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> elements) throws Exception;
    ...
    public abstract Long pfcount(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFCOUNT)
    public abstract Long pfcount(@RedisProtocolSupport.Key Buffer key1,
                                 @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFCOUNT)
    public abstract Long pfcount(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                                 @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PFCOUNT)
    public abstract Long pfcount(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PING)
    public abstract Buffer ping(Buffer message) throws Exception;
    ...
    public abstract Long pttl(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long publish(Buffer channel, Buffer message) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.CHANNELS)
    public abstract List<String> pubsubChannels(@Nullable Buffer pattern) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.CHANNELS)
    public abstract List<String> pubsubChannels(@Nullable Buffer pattern1, @Nullable Buffer pattern2) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.CHANNELS)
    public abstract List<String> pubsubChannels(@Nullable Buffer pattern1, @Nullable Buffer pattern2,
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.CHANNELS)
    public abstract List<String> pubsubChannels(Collection<Buffer> patterns) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.NUMSUB)
    public abstract <T> List<T> pubsubNumsub(@Nullable Buffer channel) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.NUMSUB)
    public abstract <T> List<T> pubsubNumsub(@Nullable Buffer channel1, @Nullable Buffer channel2) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.NUMSUB)
    public abstract <T> List<T> pubsubNumsub(@Nullable Buffer channel1, @Nullable Buffer channel2,
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PUBSUB)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.NUMSUB)
    public abstract <T> List<T> pubsubNumsub(Collection<Buffer> channels) throws Exception;
    ...
    public abstract Buffer randomkey() throws Exception;
    ...
    public abstract Long renamenx(@RedisProtocolSupport.Key Buffer key,
                                  @RedisProtocolSupport.Key Buffer newkey) throws Exception;
    ...
    public abstract Buffer rpop(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Buffer rpoplpush(@RedisProtocolSupport.Key Buffer source,
    ...
    public abstract Long rpush(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.RPUSH)
    public abstract Long rpush(@RedisProtocolSupport.Key Buffer key, Buffer value1, Buffer value2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.RPUSH)
    public abstract Long rpush(@RedisProtocolSupport.Key Buffer key, Buffer value1, Buffer value2,
                               Buffer value3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.RPUSH)
    public abstract Long rpush(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> values) throws Exception;
    ...
    public abstract Long rpushx(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
    ...
    public abstract Long sadd(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SADD)
    public abstract Long sadd(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SADD)
    public abstract Long sadd(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
                              Buffer member3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SADD)
    public abstract Long sadd(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> members) throws Exception;
    ...
    public abstract Long scard(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract <T> List<T> scriptExists(Buffer sha1) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SCRIPT)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.EXISTS)
    public abstract <T> List<T> scriptExists(Buffer sha11, Buffer sha12) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SCRIPT)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.EXISTS)
    public abstract <T> List<T> scriptExists(Buffer sha11, Buffer sha12, Buffer sha13) throws Exception;
    ...
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SCRIPT)
    @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.EXISTS)
    public abstract <T> List<T> scriptExists(Collection<Buffer> sha1s) throws Exception;
    ...
    public abstract Buffer scriptLoad(Buffer script) throws Exception;
    ...
    public abstract <T> List<T> sdiff(@RedisProtocolSupport.Key Buffer firstkey) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SDIFF)
    public abstract <T> List<T> sdiff(@RedisProtocolSupport.Key Buffer firstkey,
    ...
    public abstract Long sdiffstore(@RedisProtocolSupport.Key Buffer destination,
    ...
    public abstract Long setbit(@RedisProtocolSupport.Key Buffer key, long offset, Buffer value) throws Exception;
    ...
    public abstract Long setnx(@RedisProtocolSupport.Key Buffer key, Buffer value) throws Exception;
    ...
    public abstract Long setrange(@RedisProtocolSupport.Key Buffer key, long offset, Buffer value) throws Exception;
    ...
    public abstract <T> List<T> sinter(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SINTER)
    public abstract <T> List<T> sinter(@RedisProtocolSupport.Key Buffer key1,
                                       @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SINTER)
    public abstract <T> List<T> sinter(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                                       @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SINTER)
    public abstract <T> List<T> sinter(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Long sinterstore(@RedisProtocolSupport.Key Buffer destination,
                                     @RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long sismember(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
    ...
    public abstract <T> List<T> slowlog(Buffer subcommand) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SLOWLOG)
    public abstract <T> List<T> slowlog(Buffer subcommand, @Nullable Buffer argument) throws Exception;
    ...
    public abstract <T> List<T> smembers(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long smove(@RedisProtocolSupport.Key Buffer source, @RedisProtocolSupport.Key Buffer destination,
                               Buffer member) throws Exception;
    ...
    public abstract <T> List<T> sort(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SORT)
    public abstract <T> List<T> sort(@RedisProtocolSupport.Key Buffer key,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SORT)
    public abstract Long sort(@RedisProtocolSupport.Key Buffer key,
    ...
    public abstract Buffer spop(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SPOP)
    public abstract Buffer spop(@RedisProtocolSupport.Key Buffer key, @Nullable Long count) throws Exception;
    ...
    public abstract Buffer srandmember(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long srem(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SREM)
    public abstract Long srem(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SREM)
    public abstract Long srem(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
                              Buffer member3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SREM)
    public abstract Long srem(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> members) throws Exception;
    ...
    public abstract <T> List<T> sscan(@RedisProtocolSupport.Key Buffer key, long cursor) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SSCAN)
    public abstract <T> List<T> sscan(@RedisProtocolSupport.Key Buffer key, long cursor,
                                      @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.MATCH) @Nullable Buffer matchPattern,
                                      @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.COUNT) @Nullable Long count) throws Exception;
    ...
    public abstract Long strlen(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract <T> List<T> sunion(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SUNION)
    public abstract <T> List<T> sunion(@RedisProtocolSupport.Key Buffer key1,
                                       @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SUNION)
    public abstract <T> List<T> sunion(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                                       @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.SUNION)
    public abstract <T> List<T> sunion(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Long sunionstore(@RedisProtocolSupport.Key Buffer destination,
                                     @RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long touch(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.TOUCH)
    public abstract Long touch(@RedisProtocolSupport.Key Buffer key1,
                               @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.TOUCH)
    public abstract Long touch(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                               @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.TOUCH)
    public abstract Long touch(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Long ttl(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long unlink(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.UNLINK)
    public abstract Long unlink(@RedisProtocolSupport.Key Buffer key1,
                                @RedisProtocolSupport.Key Buffer key2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.UNLINK)
    public abstract Long unlink(@RedisProtocolSupport.Key Buffer key1, @RedisProtocolSupport.Key Buffer key2,
                                @RedisProtocolSupport.Key Buffer key3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.UNLINK)
    public abstract Long unlink(@RedisProtocolSupport.Key Collection<Buffer> keys) throws Exception;
    ...
    public abstract Buffer xadd(@RedisProtocolSupport.Key Buffer key, Buffer id, Buffer field,
                                Buffer value) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.XADD)
    public abstract Buffer xadd(@RedisProtocolSupport.Key Buffer key, Buffer id, Buffer field1, Buffer value1,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.XADD)
    public abstract Buffer xadd(@RedisProtocolSupport.Key Buffer key, Buffer id,
                                @RedisProtocolSupport.Tuple Collection<RedisProtocolSupport.BufferFieldValue> fieldValues) throws Exception;
    ...
    public abstract Long xlen(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract <T> List<T> xpending(@RedisProtocolSupport.Key Buffer key, Buffer group) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.XPENDING)
    public abstract <T> List<T> xpending(@RedisProtocolSupport.Key Buffer key, Buffer group, @Nullable Buffer start,
    ...
    public abstract <T> List<T> xrange(@RedisProtocolSupport.Key Buffer key, Buffer start, Buffer end) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.XRANGE)
    public abstract <T> List<T> xrange(@RedisProtocolSupport.Key Buffer key, Buffer start, Buffer end,
                                       @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.COUNT) @Nullable Long count) throws Exception;
    ...
    public abstract <T> List<T> xread(@RedisProtocolSupport.Key Collection<Buffer> keys,
    ...
    public abstract <T> List<T> xreadgroup(@RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.GROUP) @RedisProtocolSupport.Tuple RedisProtocolSupport.BufferGroupConsumer groupConsumer,
                                           @RedisProtocolSupport.Key Collection<Buffer> keys,
                                           Collection<Buffer> ids) throws Exception;
    ...
    public abstract <T> List<T> xrevrange(@RedisProtocolSupport.Key Buffer key, Buffer end,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.XREVRANGE)
    public abstract <T> List<T> xrevrange(@RedisProtocolSupport.Key Buffer key, Buffer end, Buffer start,
                                          @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.COUNT) @Nullable Long count) throws Exception;
    ...
    public abstract Long zadd(@RedisProtocolSupport.Key Buffer key,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZADD)
    public abstract Double zaddIncr(@RedisProtocolSupport.Key Buffer key,
                                    @RedisProtocolSupport.Tuple Collection<RedisProtocolSupport.BufferScoreMember> scoreMembers) throws Exception;
    ...
    public abstract Long zcard(@RedisProtocolSupport.Key Buffer key) throws Exception;
    ...
    public abstract Long zcount(@RedisProtocolSupport.Key Buffer key, double min, double max) throws Exception;
    ...
    public abstract Double zincrby(@RedisProtocolSupport.Key Buffer key, long increment,
                                   Buffer member) throws Exception;
    ...
    public abstract Long zlexcount(@RedisProtocolSupport.Key Buffer key, Buffer min, Buffer max) throws Exception;
    ...
    public abstract <T> List<T> zpopmax(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZPOPMAX)
    public abstract <T> List<T> zpopmax(@RedisProtocolSupport.Key Buffer key, @Nullable Long count) throws Exception;
    ...
    public abstract <T> List<T> zpopmin(@RedisProtocolSupport.Key Buffer key) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZPOPMIN)
    public abstract <T> List<T> zpopmin(@RedisProtocolSupport.Key Buffer key, @Nullable Long count) throws Exception;
    ...
    public abstract <T> List<T> zrange(@RedisProtocolSupport.Key Buffer key, long start, long stop) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZRANGE)
    public abstract <T> List<T> zrange(@RedisProtocolSupport.Key Buffer key, long start, long stop,
    ...
    public abstract <T> List<T> zrangebylex(@RedisProtocolSupport.Key Buffer key, Buffer min,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZRANGEBYLEX)
    public abstract <T> List<T> zrangebylex(@RedisProtocolSupport.Key Buffer key, Buffer min, Buffer max,
    ...
    public abstract <T> List<T> zrangebyscore(@RedisProtocolSupport.Key Buffer key, double min,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZRANGEBYSCORE)
    public abstract <T> List<T> zrangebyscore(@RedisProtocolSupport.Key Buffer key, double min, double max,
    ...
    public abstract Long zrank(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
    ...
    public abstract Long zrem(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREM)
    public abstract Long zrem(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREM)
    public abstract Long zrem(@RedisProtocolSupport.Key Buffer key, Buffer member1, Buffer member2,
                              Buffer member3) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREM)
    public abstract Long zrem(@RedisProtocolSupport.Key Buffer key, Collection<Buffer> members) throws Exception;
    ...
    public abstract Long zremrangebylex(@RedisProtocolSupport.Key Buffer key, Buffer min, Buffer max) throws Exception;
    ...
    public abstract Long zremrangebyrank(@RedisProtocolSupport.Key Buffer key, long start, long stop) throws Exception;
    ...
    public abstract Long zremrangebyscore(@RedisProtocolSupport.Key Buffer key, double min,
                                          double max) throws Exception;
    ...
    public abstract <T> List<T> zrevrange(@RedisProtocolSupport.Key Buffer key, long start, long stop) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREVRANGE)
    public abstract <T> List<T> zrevrange(@RedisProtocolSupport.Key Buffer key, long start, long stop,
    ...
    public abstract <T> List<T> zrevrangebylex(@RedisProtocolSupport.Key Buffer key, Buffer max,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREVRANGEBYLEX)
    public abstract <T> List<T> zrevrangebylex(@RedisProtocolSupport.Key Buffer key, Buffer max, Buffer min,
                                               @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.LIMIT) @Nullable @RedisProtocolSupport.Tuple RedisProtocolSupport.OffsetCount offsetCount) throws Exception;
    ...
    public abstract <T> List<T> zrevrangebyscore(@RedisProtocolSupport.Key Buffer key, double max,
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZREVRANGEBYSCORE)
    public abstract <T> List<T> zrevrangebyscore(@RedisProtocolSupport.Key Buffer key, double max, double min,
    ...
    public abstract Long zrevrank(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
    ...
    public abstract <T> List<T> zscan(@RedisProtocolSupport.Key Buffer key, long cursor) throws Exception;
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.ZSCAN)
    public abstract <T> List<T> zscan(@RedisProtocolSupport.Key Buffer key, long cursor,
                                      @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.MATCH) @Nullable Buffer matchPattern,
                                      @RedisProtocolSupport.SubCmd(RedisProtocolSupport.SubCommand.COUNT) @Nullable Long count) throws Exception;
    ...
    public abstract Double zscore(@RedisProtocolSupport.Key Buffer key, Buffer member) throws Exception;
    ...
    /**
     * Provides an alternative java API to this {@link BlockingBufferRedisCommander}. The {@link BufferRedisCommander}
     * API provides asyncronous functionality. See {@link RedisRequester#asBufferCommander} for more details.
     *
     * Note: The returned {@link BufferRedisCommander} is backed by the same {@link RedisRequester} as this
     * {@link BlockingBufferRedisCommander}.
     *
     * @return a {@link BufferRedisCommander}
     */
    public final BufferRedisCommander asBufferCommander() {
        return asBufferCommanderInternal();
    }

    BufferRedisCommander asBufferCommanderInternal() {
        return new BlockingBufferRedisCommanderToBufferRedisCommander(this);
    }
}
