...
abstract class AbstractTransactedBufferRedisCommander extends TransactedBufferRedisCommander {
    ...
    static class DiscardSingle extends Single<String> {
        ...
        private final AbstractTransactedBufferRedisCommander commander;
        final Single<String> queued;

        DiscardSingle(final AbstractTransactedBufferRedisCommander commander, final Single<String> queued) {
    ...
    static class ExecCompletable extends Completable {
        ...
        ExecCompletable(final AbstractTransactedBufferRedisCommander commander, final Single<List<Object>> queued) {
            this.commander = commander;
            this.queued = queued;
        }
        ...
        private void onSuccessUnchecked(final Object obj, final SingleProcessor single) {
