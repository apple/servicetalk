...
the I/O is complete. ServiceTalk provides link:https://www.reactive-streams.org[ReactiveStreams] compatible
...
link:https://www.reactive-streams.org[ReactiveStreams] compatible <<Asynchronous Primitives>> to enable this AP
paradigm.
