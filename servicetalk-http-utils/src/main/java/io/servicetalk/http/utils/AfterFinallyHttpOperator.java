 ...
 * }</pre>
 */
public final class AfterFinallyHttpOperator implements SingleOperator<StreamingHttpResponse, StreamingHttpResponse> {
    ...
    public SingleSource.Subscriber<? super StreamingHttpResponse> apply(
        ...
        // Here we avoid calling afterFinally#onCancel when we get a cancel() on the Single after we have handed out
        ...
        return new ResponseCompletionSubscriber(subscriber, afterFinally, discardEventsAfterCancel);
    }
                ...
                subscriber.onSuccess(response.transformMessageBody(payload ->
                        payload.liftSync(messageBodySubscriber ->
                                ...
                                stateUpdater.compareAndSet(this,
                                        ...
                                        messageBodySubscriber, afterFinally, discardEventsAfterCancel) :
