...
final class TestUtils {
    ...
    /**
     * Build a fake {@link SpanData} suitable for direct invocation of
     * {@link SpanExporter#export(Collection)}, bypassing batching so the
     * returned {@code CompletableResultCode} reflects the actual export outcome.
     */
    static SpanData fakeSpanData(String name) {
        ...
        return TestSpanData.builder()
                ...
                .setEndEpochNanos(startNs + TimeUnit.MILLISECONDS.toNanos(1))
                .setHasEnded(true)
