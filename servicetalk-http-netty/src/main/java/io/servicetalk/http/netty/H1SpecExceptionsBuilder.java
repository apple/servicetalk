 ...
 */
public final class H1SpecExceptionsBuilder {
     ...
     * @return {@code this}
     */
    public H1SpecExceptionsBuilder allowChunkedResponseWithoutBody() {
    ...
    public H1SpecExceptions build() {
        return new DefaultH1SpecExceptions(allowChunkedResponseWithoutBody);
    }

    private static final class DefaultH1SpecExceptions implements H1SpecExceptions {

        private final boolean allowChunkedResponseWithoutBody;

        DefaultH1SpecExceptions(final boolean allowChunkedResponseWithoutBody) {
