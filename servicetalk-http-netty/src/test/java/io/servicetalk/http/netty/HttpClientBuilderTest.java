...
public class HttpClientBuilderTest extends AbstractEchoServerBasedHttpRequesterTest {
    ...
    public void withConnectionFactoryFilter() throws Exception {
        ConnectionFactory<InetSocketAddress, ? extends StreamingHttpConnectionFilter> factory1 = newFilter();
        ConnectionFactory<InetSocketAddress, ? extends StreamingHttpConnectionFilter> factory2 = newFilter();
    ...
    @Nonnull
    private static ConnectionFactoryFilter<InetSocketAddress, StreamingHttpConnectionFilter> factoryFilter(
            final ConnectionFactory<InetSocketAddress, ? extends StreamingHttpConnectionFilter> factory) {
        return orig -> {
