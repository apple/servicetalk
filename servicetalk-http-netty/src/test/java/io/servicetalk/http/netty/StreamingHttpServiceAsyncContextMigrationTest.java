...
public class StreamingHttpServiceAsyncContextMigrationTest extends StreamingHttpServiceAsyncContextTest {
    ...
    void putIntoAsyncContext(final CharSequence value) {
        AsyncContext.put(K1_NEW, value);
    }

    @Nullable
    @Override
    CharSequence getFromAsyncContext() {
        return AsyncContext.get(K1_OLD);
    }

    @Override
    String keyToString() {
        return K1_NEW.toString();
    }
}
