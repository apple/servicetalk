...
public class ClientEffectiveStrategyWithFilterTest extends AbstractClientEffectiveStrategyTest {

    public ClientEffectiveStrategyWithFilterTest() throws Exception {
        super(true);
    }
