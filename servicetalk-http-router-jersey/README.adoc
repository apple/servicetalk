...
Refer to link:../servicetalk-http-security-jersey/README.adoc#auth-basic[Basic Auth for Jersey Router] for more information.
...
Refer to ServiceTalk's link:../README.adoc[main documentation]
