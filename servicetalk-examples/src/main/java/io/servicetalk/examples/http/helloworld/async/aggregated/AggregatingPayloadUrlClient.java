...
public final class AggregatingPayloadUrlClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(AggregatingPayloadUrlClient.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (CompositeCloseable resources = AsyncCloseables.newCompositeCloseable()) {
            ...
            final AggregatedHttpRequester requester = resources.prepend(
                    HttpClients.forMultiAddressUrl().buildAggregated());
