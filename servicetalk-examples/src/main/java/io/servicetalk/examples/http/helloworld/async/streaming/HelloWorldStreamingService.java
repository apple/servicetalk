 ...
 */
public final class HelloWorldStreamingService extends StreamingHttpService {
    private static final Logger LOGGER = LoggerFactory.getLogger(HelloWorldStreamingService.class);
