...
link:https://github.com/grpc/grpc/blob/main/doc/PROTOCOL-HTTP2.md[the gRPC application protocol]. We provide
...
Implementation for the link:https://github.com/grpc/grpc/blob/main/examples/protos/helloworld.proto[gRPC hello world example].
...
Implementation for the link:https://github.com/grpc/grpc/blob/main/examples/protos/route_guide.proto[gRPC route guide example].

=== Asynchronous

Asynchronous processing for different APIs in the link:https://github.com/grpc/grpc/blob/main/examples/protos/route_guide.proto[route guide service]
...
Blocking processing for different APIs in the link:https://github.com/grpc/grpc/blob/main/examples/protos/route_guide.proto[route guide service]
