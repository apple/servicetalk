...
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/priorknowledge/async/Http2Server.java[Http2Server] -
A server with an asynchronous and aggregated programming paradigm that uses HTTP/2 with Prior Knowledge.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/priorknowledge/async/Http2Client.java[Http2Client] -
A client with an asynchronous and aggregated programming paradigm that uses HTTP/2 with Prior Knowledge.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/priorknowledge/blocking/BlockingHttp2Server.java[BlockingHttp2Server] -
A server with a blocking and aggregated programming paradigm that uses HTTP/2 with Prior Knowledge.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/priorknowledge/blocking/BlockingHttp2Client.java[BlockingHttp2Client] -
A client with a blocking and aggregated programming paradigm that uses HTTP/2 with Prior Knowledge.
...
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/alpn/async/AlpnHttpServer.java[AlpnHttpServer] -
A server with an asynchronous and aggregated programming paradigm that negotiates HTTP/2 or HTTP/1.1 using ALPN extension
for TLS connections.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/alpn/async/AlpnHttpClient.java[AlpnHttpClient] -
A client with an asynchronous and aggregated programming paradigm that negotiates HTTP/2 or HTTP/1.1 using ALPN extension
for TLS connections.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/alpn/blocking/BlockingAlpnHttpServer.java[BlockingAlpnHttpServer] -
A server with a blocking and aggregated programming paradigm that negotiates HTTP/2 or HTTP/1.1 using ALPN extension
for TLS connections.
- link:{source-root}/servicetalk-examples/http/http2/src/main/java/io/servicetalk/examples/http/http2/alpn/blocking/BlockingAlpnHttpClient.java[BlockingAlpnHttpClient] -
A client with a blocking and aggregated programming paradigm that negotiates HTTP/2 or HTTP/1.1 using ALPN extension
for TLS connections.
