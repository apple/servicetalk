...
folder contains examples for the https://datatracker.ietf.org/doc/html/rfc7231[HTTP] protocol.
...
These examples demonstrate how users can configure link:https://datatracker.ietf.org/doc/html/rfc7540[HTTP/2] transport in
ServiceTalk.

=== HTTP/2 with Prior-Knowledge

This example demonstrates how to configure using
link:https://datatracker.ietf.org/doc/html/rfc7540#section-3.4[HTTP/2 transport with Prior-Knowledge] for HTTP clients and servers:
...
For secure TLS connections link:https://datatracker.ietf.org/doc/html/rfc7301[ALPN extension] could be used to negotiate the
