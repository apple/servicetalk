...
import static io.servicetalk.opentracing.inmemory.api.ListenableInMemoryScopeManager.InMemorySpanChangeListener;

/**
 * {@link InMemorySpanChangeListener} for setting trace keys into the current MDC.
 */
public final class MdcInMemorySpanChangeListener implements InMemorySpanChangeListener {
