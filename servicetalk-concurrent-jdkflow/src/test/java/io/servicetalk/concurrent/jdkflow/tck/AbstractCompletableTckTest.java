 ...
 * {@link #createFlowPublisher(long)} by yourself you should extend this class, otherwise most of the times you want to
 * extend {@link AbstractCompletableOperatorTckTest}.
 */
@Test
public abstract class AbstractCompletableTckTest extends AbstractTckTest<Object> {

    @Override
    public final java.util.concurrent.Flow.Publisher<Object> createFlowPublisher(final long elements) {
    ...
    @Override
    public final java.util.concurrent.Flow.Publisher<Object> createFailedFlowPublisher() {
