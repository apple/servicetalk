...
import static io.servicetalk.apple.traffic.resilience.http.PeerCapacityRejectionPolicy.Type.REJECT;
import static io.servicetalk.apple.traffic.resilience.http.PeerCapacityRejectionPolicy.Type.REJECT_PASSTHROUGH;
import static io.servicetalk.apple.traffic.resilience.http.PeerCapacityRejectionPolicy.Type.REJECT_RETRY;
