...
public class RedisClientTest extends BaseRedisClientTest {
    ...
    public void commandWithSubCommand() throws Exception {
        final RedisData actual = awaitIndefinitely(getEnv().client.request(newRequest(CLIENT, LIST)).ensureSingleItem());
        assertThat(actual,
    ...
    public void unknownCommandNoCoercion() throws Exception {
        ...
        assertThat(awaitIndefinitely(getEnv().client.request(newRequest(PING, reqBuf)).ensureSingleItem()),
