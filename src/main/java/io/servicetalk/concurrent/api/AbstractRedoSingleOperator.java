...
abstract class AbstractRedoSingleOperator<T> extends AbstractNoHandleSubscribeSingle<T> {

    private final Single<T> original;

    AbstractRedoSingleOperator(Single<T> original, Executor executor) {
        super(executor);
    ...
    /**
     * Subscribes the passed {@link Subscriber} to the original {@link Single}.
     *
    ...
    /**
     * Bridges this {@link Single}'s {@link Subscriber} to the original {@link Single}'s {@link Subscriber}.
     *
     * @param subscriber {@link Subscriber} to this {@link Single}.
     * @param signalOffloader  {@link SignalOffloader} for the passed {@link Subscriber}.
     * Typically, implementations will not use this {@link SignalOffloader} but just pass it to
     * {@link #subscribeToOriginal(Subscriber, SignalOffloader)} at a later point.
