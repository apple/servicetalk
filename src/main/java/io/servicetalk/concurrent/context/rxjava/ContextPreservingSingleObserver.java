...
final class ContextPreservingSingleObserver<T> implements SingleObserver<T> {
    private final AsyncContextMap saved;
    private final SingleObserver<? super T> actual;

    ContextPreservingSingleObserver(AsyncContextMap saved, SingleObserver<? super T> actual) {
