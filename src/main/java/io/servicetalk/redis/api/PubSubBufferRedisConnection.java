 ...
 */
@Generated({})
public interface PubSubBufferRedisConnection extends AsyncCloseable {
    ...
    Single<PubSubRedisMessage.Pong<Buffer>> ping();
     ...
     */
    @RedisProtocolSupport.Cmd(RedisProtocolSupport.Command.PING)
    Single<PubSubRedisMessage.Pong<Buffer>> ping(Buffer message);
}
