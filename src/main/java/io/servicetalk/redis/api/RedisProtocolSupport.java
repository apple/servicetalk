...
public final class RedisProtocolSupport {
    ...
    public enum Command implements RedisData.CompleteRequestRedisData {
        ...
        LTRIM("LTRIM", EnumSet.of(CommandFlag.WRITE), true),
    ...
    public enum SubCommand implements RedisData.CompleteRequestRedisData {
        ...
        ENCODING("ENCODING"), EXISTS("EXISTS"), FAILOVER("FAILOVER"), FLUSH("FLUSH"), FORGET("FORGET"), FREQ("FREQ"), GET("GET"),
        GETKEYS("GETKEYS"), GETKEYSINSLOT("GETKEYSINSLOT"), GETNAME("GETNAME"), HELP("HELP"), ID("ID"), IDLETIME("IDLETIME"),
        INCRBY("INCRBY"), INFO("INFO"), KEYSLOT("KEYSLOT"), KILL("KILL"), LIMIT("LIMIT"), LIST("LIST"), LOAD("LOAD"),
        MATCH("MATCH"), MEET("MEET"), NODES("NODES"), NUMPAT("NUMPAT"), NUMSUB("NUMSUB"), OBJECT("OBJECT"), OVERFLOW("OVERFLOW"),
        PAUSE("PAUSE"), REFCOUNT("REFCOUNT"), REPLICATE("REPLICATE"), REPLY("REPLY"), RESET("RESET"), RESETSTAT("RESETSTAT"),
        REWRITE("REWRITE"), SAVECONFIG("SAVECONFIG"), SEGFAULT("SEGFAULT"), SET("SET"), SET_CONFIG_EPOCH("SET-CONFIG-EPOCH"),
        SETNAME("SETNAME"), SETSLOT("SETSLOT"), SKIPME("SKIPME"), SLAVES("SLAVES"), SLOTS("SLOTS"), STORE("STORE"),
        STOREDIST("STOREDIST"), TYPE("TYPE"), WEIGHTS("WEIGHTS");
