...
public final class BlockingHttpRequests {
     ...
     * @return a new {@link BlockingHttpRequest}.
     */
    public static BlockingHttpRequest<HttpPayloadChunk> newRequest(final HttpRequestMethod method,
                                                                   final String requestTarget,
     ...
     * @return a new {@link BlockingHttpRequest}.
     */
    public static BlockingHttpRequest<HttpPayloadChunk> newRequest(final HttpProtocolVersion version,
                                                                   final HttpRequestMethod method,
                                                                   final String requestTarget,
                                                                   final Buffer payloadBody) {
     ...
     * @return a new {@link BlockingHttpRequest}.
     */
    public static BlockingHttpRequest<HttpPayloadChunk> newRequestFromBuffer(final HttpRequestMethod method,
                                                                             final String requestTarget,
     ...
     * @return a new {@link BlockingHttpRequest}.
     */
    public static BlockingHttpRequest<HttpPayloadChunk> newRequestFromBuffer(final HttpProtocolVersion version,
                                                                             final HttpRequestMethod method,
                                                                             final String requestTarget,
                                                                             final Iterable<Buffer> payloadBody) {
