...
/**
 * Factory methods for creating {@link FullHttpResponse}s.
 */
public final class FullHttpResponses {

    private FullHttpResponses() {
        // No instances
    }
     ...
     */
    public static FullHttpResponse newResponse(final HttpResponseStatus status) {
    ...
    public static FullHttpResponse newResponse(final HttpProtocolVersion version,
                                                  ...
                                                  final HttpHeaders headers,
                                                  final HttpHeaders trailers) {
        return new DefaultFullHttpResponse(new DefaultHttpResponseMetaData(status, version, headers), payloadBody,
                trailers);
    }
}
