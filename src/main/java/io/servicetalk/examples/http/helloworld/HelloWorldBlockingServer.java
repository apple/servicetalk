...
public final class HelloWorldBlockingServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ServerContext serverContext = awaitIndefinitely(starter.start(new InetSocketAddress(8080), newCachedThreadExecutor(), new HelloWorldBlockingService().asAsynchronousService()));
