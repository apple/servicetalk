...
public class DefaultSignalOffloaderConcurrentCompletableTest {

    private static final Logger LOGGER = getLogger(DefaultSignalOffloaderConcurrentCompletableTest.class);
